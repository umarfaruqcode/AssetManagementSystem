  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['submit'])) {
        ...
        $num_row = mysqli_num_rows($query_run);
          ...
          if ($num_row === 0) {
          $sql = "
           INSERT INTO asset(username, asset_type, manufacturer, model, serial_no, asset_no, asset_name, conditions, purchase_price, expected_asset_life, scrap_value, purchase_date, status)
           VALUES('$username','$asset_type', '$manufacturer', '$model', '$serial_no', '$asset_no', '$asset_name', '$conditions', '$purchase_price',  '$expected_asset_life', '$scrap_value', '$purchase_date', 'unapproved' )" or die(mysqli_error('$mysqli'));
           $query_run = mysqli_query($mysqli, $sql);
...
<li><a onclick="logout()" href="#">SIGN OUT <i class = "fa fa-sign-out"></i></a></li>
  ...
  <h6 style="text-align: center;">General Informations</h6>
