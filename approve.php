...
if(isset($_POST['search'])){
  ...
  $sql = mysqli_query($mysqli, "SELECT * FROM asset WHERE status='unapproved'");
}
 ?>
 <div class="row">
...
<!--             <td><?php echo $row['id'];?></td>
 -->            <td><?php echo $row['asset_name'];?></td>
      ...
      window.location = 'delete.php?id=<?php echo $row['id'];?>';" class="btn btn-flat"><i class="fa fa-trash red-text"></i></a></td>
            <td><a onclick="alert('Are you sure you want to Approve this asset?');
      window.location = 'cleared.php?id=<?php echo $row['id'];?>';" class="btn btn-flat"><i class="fa fa-check blue-text"></i></a>
      </td>
          </tr>
